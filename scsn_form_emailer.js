// By: Henrique Abreu
// Modified 5/30/18 by: David Ayodele
/* ---- Instructions -----
open forms sheet > click tools tab > script editor > paste script > cave >
(may need to reorder function declarations to see them as options, or rename var NAME to chosen name) >
click Run > select "onInstall" function from list > Give permission > click clock (triggers setup) >
select "time Driven", "from spreadsheet", "on form submit" > save > 
click "select function" tab > select "time driven" > save > goto spreadsheet >
(new tab should appear) click FormEmailer(or name chosen) > install, install > click FormEmailer > settings
*/
